...
def train_model_using_gradient_descent(train_data, test_data):
    ...
    for s in range(0, NrTrainingSteps):
        ...
        # 1.1 guess a random sample index
        rnd_idx = np.random.randint(0, NrTrainingSamples)

        # 1.2 get corresponding training triple
        train_sample = train_data[rnd_idx]
        w1 = train_sample[0]
        w2 = train_sample[1]
        t = train_sample[2]

        # 1.3 compute actual output y and
        ...
        # 1.5 compute error/loss on test data
    ...
    # 4. return the model parameters
    #    found during training
    return [p1,p2,p3,p4,p5,p6]



def test_model(nr_tests, params, test_data):
    ...
    for test_nr in range(0, nr_tests):
        ...
        # get the output of the network for this input
        y, _ = f(w1, w2, 0.0, params[0],params[1],params[2],params[3],params[4],params[5])

        # show actual output and desired output
        print("actual = "+str(y)+" <-> should = "+str(t))
...
def main():
    ...
    params = train_model_using_gradient_descent(train_data, test_data)

    test_model(20, params, test_data)
